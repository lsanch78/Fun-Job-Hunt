  ...
  return (
    ...
    >
      ...
      <TailoringResultPanel
        ...
        canUndo={tailoring.canUndoTailoredContent}
        canRedo={tailoring.canRedoTailoredContent}
        onUndo={tailoring.undoTailoredContent}
        onRedo={tailoring.redoTailoredContent}
