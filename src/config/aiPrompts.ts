...
// ── CV organizer (used in CVCanvas quick-paste panel) ──────────────────
// Given raw text + the current CV state, returns a diff of changes to apply.
...
export const PROMPT_CV_ORGANIZE =
  ...
  'Shape:\n' +
  '{\n' +
  '  "summary": "One sentence describing what you found — e.g. \'Found 2 new jobs, 1 project, and 4 skills not in your CV.\'",\n' +
  '  "changes": [\n' +
  '    {\n' +
  '      "action": "add" | "merge",\n' +
...
export const PROMPT_CURATE_RESUME =
  ...
  '  6. If a summary exists in the CV, select the one that best fits the JD — do not write a new one.\n' +
  ...
  '• To stay within the bullet budget, trim bullets from the LEAST relevant entries first — but NEVER drop an entire experience or project entry. Every entry in the CV must appear in the output.\n' +
  ...
  '  "summary": "<id of the best-matching summary from the CV, or null>",\n' +
  '  "experiences": [\n' +
  ...
  '• bullets arrays contain only verbatim strings copied from the CV — no edits, no additions.\n' +
